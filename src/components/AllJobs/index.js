    ...
    return noJobs ? (
      ...
      <ul className="ul-jobs-item-container">
        {jobsData.map(eachItem => (
          <AboutJobItem key={eachItem.id} jobData={eachItem} />
        ))}
      </ul>
    )
  }
    ...
    <ul className="checkboxes-container">
      {employmentTypesList.map(eachItem => (
        <li className="li-container" key={eachItem.employmentTypeId}>
          ...
          />
          <label className="label" htmlFor={eachItem.employmentTypeId}></label>
        </li>
      ))}
    </ul>
  )
    ...
    <ul className="radio-button-container">
      {salaryRangesList.map(eachItem => (
        <li className="li-container" key={eachItem.salaryRangeId}>
          ...
          />
          <label className="label" htmlFor={eachItem.salaryRangeId}></label>
        </li>
      ))}
    </ul>
  )
